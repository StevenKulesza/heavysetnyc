...
?>
	...
	<div class="gray" id="section4">
				<div class="container text-center">
					<h5 style="display: inline-block; margin-top: 24px;"><?php get_template_part( 'social' ); ?></h3>
				</div>
	</div>
	<footer id="colophon" class="color1" role="contentinfo">
...
<g>
	...
	<polygon points="602.3,428.6 602.3,445.9 621.3,445.9 621.3,492.7 644.2,492.7 644.2,445.9 663.2,445.9 663.2,428.6 	"/>
				...
				<h3 class="text-center">NYC Based Record Label & Management</h3>
				<div class="row">
					<div class="col-sm-8 footer-bar">
						© 2016 HeavySet Records&nbsp;<br class="visible-xs"><a href="<?php bloginfo('url'); ?>/site-map">Sitemap</a>&nbsp;<a href="<?php bloginfo('url'); ?>/artists">Artists</a>&nbsp;<a href="<?php bloginfo('url'); ?>/about">About</a>&nbsp;<a href="<?php bloginfo('url'); ?>/news">News</a>&nbsp;<a href="" data-toggle="modal" data-target="#contactModal">Contact</a>
					</div><!-- /.col-sm-4 -->
					
					<div class="col-sm-4 text-right">
						<p>Built By <a target="_blank" href="http://stevenkulesza.com">Steven Kulesza</a></p>
					</div><!-- /.col-sm-4 -->
				</div><!-- /.row -->
							</div><!-- /.container -->
		</div><!-- /.footer-inner -->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h3 class="modal-title text-center" id="myModalLabel">CONTACT HEAVYSET RECORDS</h3>
      </div>
      <div class="modal-body text-center">
	   <ul class="unstyled-list">
       <li><a href="mailto:az@heavysetrecordsnyc.com">EMAIL</a></li>
       <li><a target="_blank" href="https://www.instagram.com/heavysetrecordsnyc/">INSTAGRAM</a></li>
       <li><a target="_blank" href="https://soundcloud.com/heavysetrecordsnyc">SOUNDCLOUD</a></li>
       <li><a target="_blank" href="https://twitter.com/HEAVYSETRECORDS">TWITTER</a></li>
	   </ul>
      </div>
    </div>
  </div>
...
<!-- ViewPoint Checker for animation points -->
...
jQuery(document).ready(function() {
    jQuery('.fCheck').addClass("cHidden").viewportChecker({
