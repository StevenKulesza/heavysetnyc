		...
		<div class="feature-text-container text-center">
				<div class="row">
					<div class="col-sm-offset-2 col-sm-8">
						<div class="feature-text-container-left ">
...
<a class="header-text lightbox" href="https://www.youtube.com/watch?v=LWFjUzk_Qqc"><i class="fa fa-play"></i> Watch Video Now</a> 
		...
		<!-- /.feature-text-container -->	</div><!-- /.container -->
		
	<div class="shader"></div>
	<?php if (!is_mobile() || !is_tablet() || !is_handheld()) : ?>
		<div class="tv hidden-xs">
		  <div class="screen mute" id="tv"></div>
		</div>
	<?php endif; ?>
		<div class="highlight-bar text-center">
		<p class="action-bar"><a class="btn btn-primary btn-lg anchored" href="#section1"><i class="fa fa-sort-desc"></i></a></span></p>
		<div class="black-bar hidden-xs">
		<div class="container">
			<div class="row">
<div class="col-sm-2 col-sm-offset-1">
	<a href="<?php bloginfo('url'); ?>/artists">
	<h3>Artists</h3>
	</a>
</div>
<div class="col-sm-2">
...
<div class="col-sm-2">
	<a href="http://shop.heavysetrecordsnyc.com"  target="_blank">
	<h3>Shop</h3>
	</a>
</div>
<div class="col-sm-2">
